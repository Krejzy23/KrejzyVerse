  ...
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      <motion.div
        ...
        className='flex-[0.5] lg:max-w-[370px] flex flex-col justify-center gradient-05 sm:p-8 p-4 rounded-[32px] border-[1px] border-[#6a6a6a] relative'
      >
        <div className='feeedback-gradient'/>
        <div>
